...
class TestAccountMove(common.SavepointCase):
    ...
    def test_01_invoice_currency(self):
        ...
        self.assertAlmostEqual(invoice.currency_rate_amount, 1.0)
    ...
    def test_02_invoice_currency_extra(self):
        ...
        self.assertAlmostEqual(invoice.currency_rate_amount, 2.0)
        ...
        self.assertAlmostEqual(invoice.currency_rate_amount, 3.0)
